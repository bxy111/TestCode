...
begin
  case 
   ...
   insert into logs(log_dml,log_key_id,log_oldscore, log_newscore,log_date,log_user) values(var_operation, var_keyid, :old.chinese||';'||:old.math||';'||:old.english||';'||:old.complex,
